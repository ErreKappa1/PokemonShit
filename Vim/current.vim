...
silent! normal! zE
let s:l = 55 - ((20 * winheight(0) + 18) / 36)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((14 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 28 - ((12 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
28
