...
silent! normal! zE
let s:l = 48 - ((34 * winheight(0) + 28) / 57)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 46 - ((31 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 91 - ((45 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
91
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 152 + 119) / 238)
