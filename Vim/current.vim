...
silent only
silent tabonly
cd ~/Documents/Git/ErreKappa1/PokemonShit
...
silent! normal! zE
let s:l = 59 - ((36 * winheight(0) + 28) / 57)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 111 - ((50 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
111
...
wincmd w
argglobal
if bufexists("wrumple.h") | buffer wrumple.h | else | edit wrumple.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 41 - ((23 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
41
...
exe 'vert 1resize ' . ((&columns * 49 + 119) / 238)
exe '2resize ' . ((&lines * 44 + 29) / 59)
exe 'vert 2resize ' . ((&columns * 188 + 119) / 238)
exe '3resize ' . ((&lines * 11 + 29) / 59)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 35 - ((23 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 195 + 119) / 238)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 167 - ((26 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
167
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 10 - ((0 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
