...
silent! normal! zE
let s:l = 57 - ((52 * winheight(0) + 28) / 57)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((25 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
argglobal
4argu
if bufexists("pokemon_data_2.txt") | buffer pokemon_data_2.txt | else | edit pokemon_data_2.txt | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
