...
map <F12> :! ~/Coding/Bash/Random_Script/vimPush.sh
map <F11> :! ~/Coding/Bash/Random_Script/vimPull.sh
map <F10> :source Vim/current.vim
map <F9> :mksession! Vim/current.vim
map <F8> :Termdebug
map <F7> :cnext
map <F6> :cprevious
map <F5> :! clear ; ./x*
map <F4> :wa :!clear ; make
map <F3> [I:let nr = input("Which one: ")|exe "normal " . nr ."[\t"
map <F1> :wa :!clear  :make
...
wincmd w
argglobal
if bufexists("pokemon_data.txt") | buffer pokemon_data.txt | else | edit pokemon_data.txt | endif
balt types.txt
setlocal keymap=
setlocal noarabic
setlocal autoindent
